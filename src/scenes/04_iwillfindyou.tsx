...
export default makeScene2D(function* (view) {
	...
	yield txt_offset(-357, 0.2, easeInOutSine);
	yield* waitUntil("night");
	yield streetlights.night().lightWidth(750, 0.3, easeOutBack);
	yield txt_offset(-816, 0.2, easeInOutSine);
